...
public class Field2048 : MonoBehaviour
{
    ...
    [Space(10)]
    [SerializeField] private Cell2048 cellPref;
    ...
    private void Start()
    {
        SwipeDetection2048.SwipeEvent += OnInput;
    }
    ...
    {
        if (!GameController2048.GameStarted)
            return;
    ...
    private void CheckGameResult()
    {
        ...
        for (int x = 0; x < FieldSize; x++)
        {
            for (int y = 0; y < FieldSize; y++)
            {
                ...
                {
                    GameController2048.Instance.Win();
                    return;
                }
        ...
        if (lose)
        {
            GameController2048.Instance.Lose();
        }
    }
    ...
    private void GenerateRandomCell()
    {
        ...
        CellAnimationController2048.Instance.SmoothAppear(cell);
    }
